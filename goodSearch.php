...
<div class="content">
    ...
    <div class="panel panel-default">
        <div class="panel-body search-firstline">
            ...
            <ul>
                <li style="margin-right: 40px;<?php echo ($order=='default'||$order=='')?"font-weight:bolder":"";?>"><a href="goodSearch.php?order=default&goodsearch=<?php echo $goodsearch;?>">默认排序</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='timefromnew')?"font-weight:bolder":"";?>"><a href="goodSearch.php?order=timefromnew&goodsearch=<?php echo $goodsearch;?>">按时间降序排序</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='timefromold')?"font-weight:bolder":"";?>"><a href="goodSearch.php?order=timefromold&goodsearch=<?php echo $goodsearch;?>">按时间升序排序</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='pricefromhigh')?"font-weight:bolder":"";?>"><a href="goodSearch.php?order=pricefromhigh&goodsearch=<?php echo $goodsearch;?>">按价格从高到低</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='pricefromlow')?"font-weight:bolder":"";?>"><a href="goodSearch.php?order=pricefromlow&goodsearch=<?php echo $goodsearch;?>">按价格从低到高</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='soldfromhigh')?"font-weight:bolder":"";?>"><a href="goodSearch.php?order=soldfromhigh&goodsearch=<?php echo $goodsearch;?>">按销量从高到低</a></li>
                <li style="margin-right: 40px;<?php echo ($order=='soldfromlow')?"font-weight:bolder":"";?>"><a href="goodSearch.php?order=soldfromlow&goodsearch=<?php echo $goodsearch;?>">按销量从低到高</a></li>
            </ul>
        </div>
    </div>
    <div class="row">
