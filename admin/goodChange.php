...
<div class="container">
    ...
    <h4>修改商品信息</h4>
    <form method="post" action="goodChangeHandle.php?id=<?php echo $data['GoodId'];?>" enctype="multipart/form-data" role="form" style="width: 300px;margin: 0 auto; margin-top: 20px;">
        ...
        <div class="form-group">
            ...
            <input class="form-control" type="text" name="goodsummary" size="20" value="<?php echo $data['GoodSummary']; ?>">
        </div>
        <div class="form-group">
