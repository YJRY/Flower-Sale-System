        ...
        <div class="panel panel-default">
            <div class="panel-body search-firstline">
                ...
                <ul>
                    ...
                    <li style="margin-right: 40px;<?php echo ($order=='timefromnew')?"font-weight:bolder":"";?>"><a href="hotGoods.php?order=timefromnew">按时间降序排序</a></li>
                    <li style="margin-right: 40px;<?php echo ($order=='timefromold')?"font-weight:bolder":"";?>"><a href="hotGoods.php?order=timefromold">按时间升序排序</a></li>
                    <li style="margin-right: 40px;<?php echo ($order=='pricefromhigh')?"font-weight:bolder":"";?>"><a href="hotGoods.php?order=pricefromhigh">按价格从高到低</a></li>
                    <li style="margin-right: 40px;<?php echo ($order=='pricefromlow')?"font-weight:bolder":"";?>"><a href="hotGoods.php?order=pricefromlow">按价格从低到高</a></li>
                    <li style="margin-right: 40px;<?php echo ($order=='soldfromhigh')?"font-weight:bolder":"";?>"><a href="hotGoods.php?order=soldfromhigh">按销量从高到低</a></li>
                    <li style="margin-right: 40px;<?php echo ($order=='soldfromlow')?"font-weight:bolder":"";?>"><a href="hotGoods.php?order=soldfromlow">按销量从低到高</a></li>
                </ul>
            </div>
        </div>
